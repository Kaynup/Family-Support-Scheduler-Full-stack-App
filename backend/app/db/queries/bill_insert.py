...
def insert_bill(name, due_date, total_amount, creation_date, status, category, recurring_interval, user_id=None):
    """
    ...
    if user_id is not None:
        ...
        """
        values = (name, creation_date, due_date, total_amount, status, category, recurring_interval, user_id)
    else:
        query = f"""
        INSERT INTO {_TABLE}
